export default class FrmVal {
  ...
  _toggleSub = () => {
    ...
    this._subBtn.classList.toggle(this._popSubDis, !this._valState);
  };
  ...
  enableVal = () => {
    this._frmInps = this._frm.querySelectorAll(this._popInp);
  ...
  _resInps = () => this._frmInps.forEach(inp => this._hideErr(inp));
